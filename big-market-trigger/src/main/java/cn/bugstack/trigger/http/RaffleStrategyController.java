...
import cn.bugstack.trigger.api.dto.resp.*;
...
import static cn.bugstack.types.common.ResponseCode.UN_ERROR;
...
public class RaffleStrategyController implements IRaffleStrategyService {
    ...
    public Response<List<RaffleAwardListResponseDTO>> queryRaffleAwardList(@RequestBody RaffleAwardListRequestDTO request) {
        try {
            log.info("查询抽奖奖品列表配开始 requestDTO：{}", request);
            ...
            log.error("查询奖品列表，失败 request:{}", request, appException);
            return Response.<List<RaffleAwardListResponseDTO>>builder()
            ...
            log.error("查询奖品列表，失败 request:{}", request, e);
            return Response.<List<RaffleAwardListResponseDTO>>builder()
    ...
    public Response<List<RaffleStrategyRuleWeightResponseDTO>> queryRaffleStrategyRuleWeight(@RequestBody RaffleStrategyRuleWeightRequestDTO request) {
        try {
            ...
            log.error("查询抽奖策略权重规则", request, e);
            return Response.<List<RaffleStrategyRuleWeightResponseDTO>>builder()
                    .code(e.getCode())
                    .info(e.getInfo())
                    .build();
        } catch (Exception e) {
            log.error("查询抽奖策略权重规则", e);
            return Response.<List<RaffleStrategyRuleWeightResponseDTO>>builder()
                    .code(ResponseCode.UN_ERROR.getCode())
                    .info(ResponseCode.UN_ERROR.getInfo())
                    .build();
