...
public abstract class AbstractRaffleStrategy implements IRaffleStrategy {
    ...
    public RaffleAwardEntity performRaffle(RaffleFactorEntity raffleFactorEntity) {
        ...
        if (!DEFAULT.getChainName().equals(chainStrategyAward.getLogicModel())) {
            StrategyAwardEntity strategyAward = strategyRepository.queryStrategyAwardEntity(raffleFactorEntity.getStrategyId(), chainStrategyAward.getAwardId());
        ...
        StrategyAwardVO treeStrategyAward = this.raffleLogicTree(raffleFactorEntity.getUserId(),
                raffleFactorEntity.getStrategyId(), chainStrategyAward.getAwardId(), raffleFactorEntity.getEndDateTime());
        ...
        StrategyAwardEntity strategyAward = strategyRepository.queryStrategyAwardEntity(raffleFactorEntity.getStrategyId(), treeStrategyAward.getAwardId());
     ...
     * @return 过滤结果【奖品ID，会根据抽奖次数判断、库存判断、兜底兜里返回最终的可获得奖品信息】
     */
    public abstract StrategyAwardVO raffleLogicTree(String userId, Long strategyId, Integer awardId, Date endDateTime);
